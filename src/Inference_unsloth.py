...
pipe = pipeline(task="text-generation", model=model,do_sample=True,top_p=0.95,top_k=50,penalty_alpha=0.6,tokenizer=tokenizer,temperature=0.8,max_length=1024)
