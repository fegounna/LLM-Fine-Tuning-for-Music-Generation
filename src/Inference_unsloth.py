...
pipe = pipeline(task="text-generation", model=model,do_sample=True,tokenizer=tokenizer,top_k=10,temperature=0.8,top_p=0.95,penalty_alpha=0.3,max_length=1024)
