...
pipe = pipeline(task="text-generation", model=model,do_sample=True,top_p=0.95,penalty_alpha=0.6,tokenizer=tokenizer,top_k=1000,temperature=0.7,max_length=2048)
