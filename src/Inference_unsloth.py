...
pipe = pipeline(task="text-generation", model=model,do_sample=True,tokenizer=tokenizer,temperature=0.8,top_k=10,penalty_alpha=0.1,top_p=0.9,max_length=2048)
