...
pipe = pipeline(task="text-generation", model=model,do_sample=True,tokenizer=tokenizer,temperature=0.85,top_k=10,penalty_alpha=0.6,top_p=0.95,max_length=2048)
