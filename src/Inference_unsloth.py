...
pipe = pipeline(task="text-generation", model=model,do_sample=True,top_p=0.95,top_k=50,tokenizer=tokenizer,penalty_alpha=0.6,temperature=0.7,max_length=1024)
