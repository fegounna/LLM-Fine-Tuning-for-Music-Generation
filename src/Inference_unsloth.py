...
peft_model_id = '/users/eleves-a/2022/yessin.moakher/output/llama-2-music_4k_2_ep/'
device_map = {"": 0}
...
pipe = pipeline(task="text-generation", model=model,do_sample=True,tokenizer=tokenizer,top_k=10,temperature=0.8,top_p=0.95,penalty_alpha=0.6,max_length=4096)
