...
# a little bit modified, to take in argument the title of the jam file and the title
def jams_to_midi(jam_file_title, q=1, title='output.mid'):
    # q = 1: with pitch bend. q = 0: without pitch bend.
    jam = jams.load(jam_file_title)
